...
private fun getSums(rowIndex: Int, colIndex: Int): Int {
    ...
    if (rowIndex >= 1) {
        if (lines[rowIndex - 1][colIndex].isDigit()) {
            sum += getSum(rowIndex - 1, colIndex)
        }
    }
    ...
    if (rowIndex >= 1 && !lines[rowIndex - 1][colIndex].isDigit()) {
        ...
        if (colIndex >= 1 && lines[rowIndex - 1][colIndex - 1].isDigit()) {
            sum += getSum(rowIndex - 1, colIndex - 1)
        }
    ...
    if (colIndex >= 1) {
        if (lines[rowIndex][colIndex - 1].isDigit()) {
            sum += getSum(rowIndex, colIndex - 1)
        }
    }
...
private fun getSum(rowIndex: Int, colIndex: Int): Int {
    var start = colIndex
    var end = colIndex
